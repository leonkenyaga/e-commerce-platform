        ...
        <div className="mt-6 sm:mt-8 lg:mt-0">
          ...
          <div className="mt-6 sm:gap-4 sm:items-center sm:flex sm:mt-8">
            <a
              href="#"
              title=""
              className="flex items-center justify-center py-2.5 px-5 text-sm font-medium focus:outline-none bg-black rounded-lg border-black fill-white text-white"
              role="button"
            >
              <svg
            ...
            <a
              href="#"
              title=""
              className="text-white mt-4 sm:mt-0  focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 focus:outline-none flex items-center justify-center bg-black"
              role="button"
            >
              <svg
                className="w-5 h-5 -ms-2 me-2"
